...
class MasyarakatSeeder extends Seeder
{
    ...
    private const MASYARAKAT_DATA = [
        [
            'nama' => 'Siti Nurhaliza',
            'email' => 'siti.nurhaliza@simpan.id',
        ...
        [
            ...
            'email' => 'ratna.wijayanti@simpan.id',
        ...
        [
            'nama' => 'Susi Handayani',
            'email' => 'susi.handayani@simpan.id',
        ...
        [
            'nama' => 'Hendra Gunawan',
            'email' => 'hendra.gunawan@simpan.id',
        ...
        [
            ...
            'email' => 'mushawwir.rahman@simpan.id',
        ...
        [
            'nama' => 'M Fauzan Gumilang',
            'email' => 'fauzan@simpan.id',
            'nik' => '3206451994020122',
            'nomor_telepon' => '6281313747177',
            'tanggal_lahir' => '1994-02-08',
            'jenis_kelamin' => 'L',
            'alamat' => 'Jl. Teuku Umar No. 92',
